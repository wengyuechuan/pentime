...
export function getModelLogoById(modelId: string): string | undefined {
  ...
  const logoMap = {
    ...
    'gpt-image': isLight ? ChatGptModelLogo : ChatGptModelLogoDark,
    'gpt-': isLight ? ChatGptModelLogo : ChatGptModelLogoDark,
    gpts: isLight ? ChatGptModelLogo : ChatGptModelLogoDark,
    ...
    '(^|[-_/])sora([-_/.]|$)': isLight ? ChatGptModelLogo : ChatGptModelLogoDark,
