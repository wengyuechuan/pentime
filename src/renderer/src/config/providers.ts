...
export const CHERRYAI_DEFAULT_MODEL: Model = {
  id: 'Qwen/Qwen3-8B',
  provider: 'cherryai',
  name: 'Qwen3-8B',
  group: 'Qwen'
...
export const MODEL_SERVICE_PROVIDER_IDS = [
  'new-api',
  'ollama',
  'nvidia',
  'dashscope',
...
export const MODEL_SERVICE_PROVIDER_ID_SET = new Set<string>(MODEL_SERVICE_PROVIDER_IDS)
...
export const PROVIDER_URLS: Record<SystemProviderId, ProviderUrls> = {
  ...
  'new-api': {
    api: {
      url: 'https://api.siivsd.com'
    },
    websites: {
      official: 'https://www.pentime-api.com',
      docs: 'https://www.pentime-api.com'
    }
  },
  'aws-bedrock': {
    api: {
