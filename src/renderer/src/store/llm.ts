...
import { MODEL_SERVICE_PROVIDER_IDS, SYSTEM_PROVIDERS_CONFIG } from '@renderer/config/providers'
...
export const initialState: LlmState = {
  ...
  quickAssistantId: '',
  providers: MODEL_SERVICE_PROVIDER_IDS.map((id) => SYSTEM_PROVIDERS_CONFIG[id]),
  settings: {
    ollama: {
      keepAliveTime: 0
    },
