...
const PENTIME_NEW_URL = 'https://www.pentime-new.com'
...
const AboutSettings: FC = () => {
  ...
  const mailto = async () => {
    const email = 'support@pentime-new.com'
  ...
  const onOpenDocs = () => {
    void window.api.openWebsite(PENTIME_NEW_URL)
  }
  ...
  return (
    <SettingContainer theme={theme}>
      <SettingGroup theme={theme}>
        ...
        <AboutHeader>
          <Row align="middle">
            <AvatarWrapper onClick={() => onOpenWebsite(PENTIME_NEW_URL)}>
            ...
            <VersionWrapper>
              ...
              <Description>Pentime-AI工具</Description>
              <Tag
                onClick={() => onOpenWebsite(PENTIME_NEW_URL)}
                color="cyan"
      ...
      <SettingGroup theme={theme}>
        ...
        <SettingRow>
          ...
          <Button onClick={() => onOpenWebsite(PENTIME_NEW_URL)}>{t('settings.about.website.button')}</Button>
        </SettingRow>
        <SettingDivider />
        <SettingRow>
          <SettingRowTitle>
          ...
          <Button onClick={() => onOpenWebsite(PENTIME_NEW_URL)}>{t('settings.about.feedback.button')}</Button>
        </SettingRow>
        <SettingDivider />
        <SettingRow>
          <SettingRowTitle>
        ...
        <SettingRow>
          ...
          <Button onClick={() => onOpenWebsite(PENTIME_NEW_URL)}>{t('settings.about.careers.button')}</Button>
        </SettingRow>
        <SettingDivider />
        <SettingRow>
          <SettingRowTitle>
