...
const PopupContainer: React.FC<Props> = ({ provider, resolve }) => {
  ...
  const [type, setType] = useState<ProviderType>(provider?.type || 'new-api')
  const [displayType, setDisplayType] = useState<string>(provider?.type || 'new-api')
