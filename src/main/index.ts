...
crashReporter.start({
  companyName: 'Pen-Time',
  productName: 'Pen-Time',
  submitURL: '',
 ...
 */
if (isLinux) {
  app.commandLine.appendSwitch('class', 'Pen-Time')
  app.commandLine.appendSwitch('name', 'Pen-Time')
}
...
if (!app.requestSingleInstanceLock()) {
  ...
  void app.whenReady().then(async () => {
    ...
    electronApp.setAppUserModelId(import.meta.env.VITE_MAIN_BUNDLE_ID || 'com.pentime.app')
